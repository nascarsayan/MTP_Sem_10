...
\usepackage[square,sort,comma,numbers]{natbib} % Use the natbib reference package - read up on this to edit the reference style; if you want text (e.g. Smith et al., 2012) for the in-text references (instead of numbers), remove 'numbers' v
...
The topic of interest is Emotion Recognition and Estimation. If a machine can recognize the emotional state of the user, it will be possible to automate tasks taking into account the current emotional state of the user. There are several ways to recognize emotional states, and here we will use EEG signals for this task.
}
...
I would like to sincerely thank Professor Debasis Samanta and Miss Sricheta Parui for their valuable guidance. They've supported me in both good and bad times and have been quite understanding. 
}
\clearpage % Start a new page
